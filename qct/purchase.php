...
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
    ...
    <!-- Document Title
    ============================================= -->
    <title>QCT Purchasing Options</title>
...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
        ...
        ==============================-->
        <div class="section parallax nomargin clearfix" style="background-image: url('../images/product-overviews/qct/quilt-bg-light.jpg'); border-bottom:4px solid #B14949;" data-stellar-background-ratio="0.2">
            ...
            <div class="container center">
                    ...
                    <div class="heading-block center nomargin">
                        ...
                        <img src="/images/product-overviews/qct/qctouch-logo-blue.png" alt="Quilter's Creative Touch Logo">
...
========================================-->
                    ...
                    <div class="container bottommargin">
                          ...
                          <div class="row">
                              <div class="col-sm-4 center">
                                <img src="../images/product-overviews/qct/machine.png" />
                              ...
                              <div class="col-sm-4">
                                <img src="../images/product-overviews/qct/qct-version.png" />
            ...
            <!--Versions!
            ===================================-->
            <div class="section parallax nomargin" style="background-image:url('../images/backgrounds/light_wool.png'); background-repeat:repeat; border-top:4px solid #B14949; border-bottom:4px solid #B14949;"  data-stellar-background-ratio="0.1">
                    ...
                    <div class="row topmargin-sm" style="padding:50px;">
                                <div class="col-md-6 center">
                                    <img class="divcenter" src="../images/product-overviews/qct/logo-beginnings.png" alt="QCT Beginnings Logo" />
                                 ...
                                 <div class="col-md-6 center col-last">
                                    <img src="../images/product-overviews/qct/logo-qct.png" alt="QCT Logo" />
                    ...
                    <div class="row" style="padding:50px;">
                                <div class="col-md-6 center">
                                    <img src="../images/product-overviews/qct/logo-qct-silver.png" alt="QCT Silver Logo" />

                                    <p>Quilter’s Creative Touch puts precision quilting at your fingertips. Choose from the vast library of included patterns and pantographs, or design your own! This full version of Quilter's Creative Touch has more advanced creation and pattern placement options than QCT Beginnings.</p>
                                </div>

                                 <div class="col-md-6 center col-last">
                                    <img src="../images/product-overviews/qct/logo-qct-gold.png" alt="QCT Gold Logo" />
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="block-img" style="-webkit-box-shadow: 1px 1px 7px 1px rgba(0,0,0,0.25);
                            ...
                            <img src="../images/product-overviews/qct/motor-plate.jpg" alt="QCT Motor Plate">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="block-img" style="-webkit-box-shadow: 1px 1px 7px 1px rgba(0,0,0,0.25);
                            -moz-box-shadow:  1px 1px 7px 1px rgba(0,0,0,0.25));
                            box-shadow:  1px 1px 7px 1px rgba(0,0,0,0.25);">
                            <img src="../images/product-overviews/qct/usb.jpg" alt="QCT Motor Plate">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="block-img" style="-webkit-box-shadow: 1px 1px 7px 1px rgba(0,0,0,0.25);
                            -moz-box-shadow:  1px 1px 7px 1px rgba(0,0,0,0.25);
                            box-shadow:  1px 1px 7px 1px rgba(0,0,0,0.25);">
                            <img src="../images/product-overviews/qct/tablet-mount.jpg" alt="QCT Motor Plate">
                        </div>
                    </div>
                </div>
