...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Quilter's Creative Touch Features</title>
        ...
        <section id="content">
            ...
            <div class="content-wrap">
                ...
                <div class="container clearfix">
                        ...
                        <section id="topofpage">
                            ...
                            <div class="row clearfix center bottommargin">
                                <div class="col-xs-4 col-sm-3">
                                    <a href="#library" data-scrollto="#library"><img src="images/product-overviews/qct/features/ico-library.png" /><br />Extensive Pattern Library</a>
                                </div>
                                
                                <div class="col-xs-4 col-sm-3">
                                    <a href="#place" data-scrollto="#place"><img src="images/product-overviews/qct/features/ico-place.png" /><br />Precise Placements</a>
                                </div>

                                <div class="col-xs-4 col-sm-3">
                                    <a href="#panto" data-scrollto="#panto"><img src="images/product-overviews/qct/features/ico-pantostacker.png" /><br />Easy Pantograph Rows</a>
                                </div>

                                <div class="col-xs-4 col-sm-3">
                                    <a href="#patterncad" data-scrollto="#patterncad"><img src="images/product-overviews/qct/features/ico-patterncad.png" /><br />Pattern Design</a>
                                </div>

                                <div class="col-xs-4 col-sm-3">
                                    <a href="#quiltcad" data-scrollto="#quiltcad"><img src="images/product-overviews/qct/features/ico-quiltcad.png" /><br />Quilt Layout</a>
                                </div>

                                <div class="col-xs-4 col-sm-3">
                                    <a href="#trace" data-scrollto="#trace"><img src="images/product-overviews/qct/features/ico-trace.png" /><br />Trace Photographs</a>
                                </div>

                                <div class="col-xs-4 col-sm-3">
                                    <a href="#optimize" data-scrollto="#optimize"><img src="images/product-overviews/qct/features/ico-optimize.png" /><br />Pattern Optimizer</a>
                                </div>

                                <div class="col-xs-4 col-sm-3">
                                    <a href="#print" data-scrollto="#print"><img src="images/product-overviews/qct/features/ico-print.png" /><br />Print Patterns</a>
                                </div>

                                <div class="col-xs-4 col-sm-3">
                                    <a href="#record" data-scrollto="#record"><img src="images/product-overviews/qct/features/ico-record.png" /><br />Record Free-motion</a>
                                </div>

                                <div class="col-xs-4 col-sm-3">
                                    <a href="#borders" data-scrollto="#borders"><img src="images/product-overviews/qct/features/ico-borders.png" /><br />Easy Border Design</a>
                                </div>

                                <div class="col-xs-4 col-sm-3">
                                    <a href="#vl" data-scrollto="#vl"><img src="images/product-overviews/qct/features/ico-vl.png" /><br />Extend Your Reach</a>
                                </div>

                                <div class="col-xs-4 col-sm-3">
                                    <a href="#fonts" data-scrollto="#fonts"><img src="images/product-overviews/qct/features/ico-fonts.png" /><br />Design With Fonts</a>
                                </div>
                            </div>
                    ...
                    <!--features
                                       =============================-->
                                    <section class="clearfix"  style="background-image:URL(images/backgrounds/square_bg.png); background-repeat:repeat;">
                                        <div class="container topmargin" id="library" >
                                               
                                        
                                               <div class="heading-block center nomargin">
                                                   <img class="center qct-main-image1" src="images/product-overviews/qct/features/library.png">
                                       ...
                                       <section id="place" class="container clearfix topmargin">
                                               ...
                                               <div class="heading-block center nomargin">
                                                   <img class="qct-main-image2" src="images/product-overviews/qct/features/place.jpg">
                 ...
                 <!--Brien's new stuff
                                      ...
                                      ================================-->
                                        ...
                                        <div class="container topmargin" id="panto">
                                               ...
                                               <div class="heading-block center nomargin">
                                                   <img class="center qct-main-image1" src="images/product-overviews/qct/features/pantostacker.png">
                                       ...
                                       <section id="patterncad" class="container clearfix topmargin">
                                               ...
                                               <div class="heading-block center nomargin">
                                                   <img class="qct-main-image1" src="images/product-overviews/qct/features/patterncad.png">
                                        ...
                                        <div class="container topmargin" id="quiltcad">
                                               ...
                                               <div class="heading-block center nomargin">
                                                   <img class="center qct-main-image1" src="images/product-overviews/qct/features/quiltcad.png">
                                                   <h3>Quilt Layout</h3>
                                       ...
                                       <section id="trace" class="container clearfix topmargin">
                                               ...
                                               <div class="heading-block center nomargin">
                                                   <img class="qct-main-image1" src="images/product-overviews/qct/features/trace.png">
                                        ...
                                        <div class="container topmargin" id="optimize">
                                               ...
                                               <div class="heading-block center nomargin">
                                                   <img class="center qct-main-image1" src="images/product-overviews/qct/features/optimize.png">
                                       ...
                                       <section id="print" class="container clearfix topmargin">
                                               ...
                                               <div class="heading-block center nomargin">
                                                   <img class="qct-main-image1" src="images/product-overviews/qct/features/print.png">
                                        ...
                                        <div class="container topmargin" id="record">
                                               ...
                                               <div class="heading-block center nomargin">
                                                   <img class="center qct-main-image2" src="images/product-overviews/qct/features/record.jpg">
                                       ...
                                       <section id="borders" class="container clearfix topmargin">
                                               ...
                                               <div class="heading-block center nomargin">
                                                   <img class="qct-main-image1" src="images/product-overviews/qct/features/borders.png">
                                        ...
                                        <div class="container topmargin" id="vl">
                                               ...
                                               <div class="heading-block center nomargin">
                                                   <img class="center qct-main-image2" src="images/product-overviews/qct/features/vl.jpg">
                                       ...
                                       <section id="fonts" class="container clearfix topmargin">
                                               ...
                                               <div class="heading-block center nomargin">
                                                   <img class="qct-main-image1" src="images/product-overviews/qct/features/fonts.png">
